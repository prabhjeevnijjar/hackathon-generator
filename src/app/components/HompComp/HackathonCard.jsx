...
const HackathonCard = () => {
  return (
    <div className="bg-white flex flex-col w-[300px] md:w-[300px] xl:w-[350px] rounded-xl">
      <img src={hackImg.src}></img>
      <div className="flex flex-col text-center justify-center items-center my-4 gap-5  ">
        <div className="rounded-[5px] font-semibold leading-[1rem] text-[0.75rem] text-[#666666] px-2 py-1 bg-[#F2C94C40]">Upcoming</div>
        <div className="font-semibold leading-[1.625rem] px-12">Data Science Bootcamp - Graded Datathon</div>
      </div>
