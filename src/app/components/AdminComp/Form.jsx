    ...
    <div className="px-[2rem] md:px-[6rem] 2xl:px-[25rem]">
      <div className="flex flex-col w-full max-w-md items-center gap-1.5 z-2 my-7">
        <div className="grid w-full max-w-sm items-center gap-1.5 z-2 mt-3">
          ...
          <input name="name" type="text" id="name" placeholder="Name" required className="rounded-[5px] border px-2 py-1 mt-4" />
        </div>
        <div className="grid w-full max-w-sm items-center gap-1.5 z-2 mt-6">
          ...
          <input name="email" type="date" id="email" placeholder="Email" required className="rounded-[5px] border px-2 py-1 mt-4" />
        </div>
        <div className="grid w-full max-w-sm items-center gap-1.5 z-2 mt-6">
          <label htmlFor="Username" className="leading-[1.187rem] text-[#333333]">
            End Date
          </label>
          <input name="username" type="date" id="Username" placeholder="Username" className="rounded-[5px] border px-2 py-1 mt-4" />
        </div>
        <div className="grid w-full max-w-sm items-center gap-1.5 z-2 mt-6">
          <label htmlFor="name" className="leading-[1.187rem] text-[#333333]">
            Description
          </label>
          <textarea cols="60" rows="10" name="name" type="text" id="name" placeholder="Name" required className="rounded-[5px] border px-2 py-1 mt-4" />
        </div>
        <div className="grid w-full max-w-sm items-center gap-1.5 z-2 mt-6">
          <label htmlFor="name" className="leading-[1.187rem] text-[#333333]">
            Image
              ...
              <div className="cursor-pointer text-center text-[#44924C] hover:text-green-800">
                <span className="flex flex-row items-center gap-2 mt-2 ">
                  ...
                  <svg width="12" height="11" viewBox="0 0 12 11" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M6.625 1L11 5.375L6.625 9.75M11 5.375H1" stroke="#44924C" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round" />
                  </svg>
                </span>
              </div>
            </label>
        ...
        <div className="grid w-full max-w-sm items-center gap-1.5 z-2 mt-6">
          ...
          <select name="name" id="name" placeholder="Name" required className="rounded-[5px] border px-2 py-1 mt-4" />
        </div>
        <div className="grid w-full max-w-sm items-center gap-1.5 z-2 mt-6">
